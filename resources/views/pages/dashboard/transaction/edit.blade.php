            ...
            <form action="{{ route('dashboard.transaction.update', $item->id) }}" class="w-full" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex flex-wrap -max-3 mb-6">
                    <div class="w-full px-3 mb-6">
                        ...
                        <select name="status" id="status"  class="block w-full bg-gray-700 border boder-gray-200 rounded py-3 px-4 leading-light focus:outline-none focus:bg-white focus:border-gray-500">
